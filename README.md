...
- To setup BAND_RX field for the ADIF, use "SDR Setup" menu:
<p align="center">
<img src="https://github.com/VK6NX/OCLog-v1.x/blob/main/images/bandrx.png" width="50%" height="50%">
</p>
It works in combination VFO A (primary or FREQ) and VFO B (BAND_RX) or VFO B FREQ) and VFO A (BAND_RX). If combination VFO A -VFO A or VFO B-VFO B is chosen, BAND_RX field in ADIF equal '0'.
