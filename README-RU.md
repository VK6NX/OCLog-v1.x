...
Выбор "режима" лога (Обычный, DXпедиция, контест) одновременно отправляет конфигурацию в TCI Skimmer. Соответственно, TCI Skimmer переключается в соответствующий режим, меняя алгоритм декодирования на выбранный (Обычный, DXпедиция, контест).
